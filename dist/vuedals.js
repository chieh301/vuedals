...
// imports
// module
exports.push([module.id,'body.vuedal-open{overflow:hidden}.vuedals{background-color:rgba(0,0,0,.5);position:fixed;top:0;left:0;right:0;bottom:0;z-index:1050;overflow-x:hidden;overflow-y:auto;perspective:500px;transition:opacity .4s ease}.vuedal{background:#fff;box-shadow:3px 5px 20px #333;margin:30px 0;transition:all .6s ease;position:absolute;left:50%;transform:translateX(-50%);will-change:transform;width:650px}.vuedal.xl{width:1024px}.vuedal.lg{width:850px}.vuedal.sm{width:550px}.vuedal.xs{width:350px}@media (max-width:768px){.vuedal{width:90%}}.vuedal.disabled{opacity:.2}.vuedal.disabled:after{background:transparent;content:"";position:absolute;top:0;left:0;right:0;bottom:0;z-index:100}.vuedal header{padding:20px;border-bottom:1px solid #eee;min-height:32px;margin-bottom:20px}.vuedal header .title{font-size:21px;font-weight:100}.vuedal header .close{float:right;font-size:26px;font-weight:100;line-height:21px;cursor:pointer}.vuedal .vuedal-body{padding:0 20px}.vuedal footer .actions{display:flex;flex:0 1 auto;width:100%;border-top:1px solid #ebebeb}.vuedal footer .actions button{flex:1 1 auto;font-size:12px!important;background:transparent;padding:0;margin:0;border:0;cursor:pointer;line-height:40px;height:40px;color:inherit;font:inherit;outline:none}.vuedal footer .actions button:hover{background:#ebebeb}.vuedal footer .actions button:not(:first-of-type){border-left:1px solid #ebebeb}.vuedal-enter,.vuedal-leave-active{opacity:0}.vuedal-enter .vuedal,.vuedal-leave-active .vuedal{opacity:0;transform:translateX(-50%) translateY(-30px) scale(.95)}',""])},/* 26 */
/***/
function(module,exports){/*
